...
# Config:
# User-defined inputs
data_path = os.path.join('/', 'zfs', 'disinfo', 'hunts', 'Africa_Elections', 'EconomicFreedomFightersMarch25.csv')
output_dir = os.path.join('/', 'zfs', 'disinfo', 'hunts', 'Africa_Elections', 'frame_extraction_analysis', 'outputs', 'EconomicFreedomFightersMarch25')
text_col = 'Message'
