...
def process_and_save_tweets(input_path, results_dir='./', labeled_data_path='./data/labeled_data.csv', text_col='text', api_key_loc='./openai_api_key.txt', raw_csv_or_intermediate='c'):
